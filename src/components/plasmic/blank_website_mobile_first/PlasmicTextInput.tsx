...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: cJN_OkWw8mUp/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__p3Tgv)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__yu2WY)}
              role={"img"}
            />
          ),
